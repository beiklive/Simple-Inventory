    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->info_label->setText(QStringLiteral("Ground坐标: ") + QString::number(GroundPosX) + ", " + QString::number(GroundPosY));
...
void MainWindow::ReadAllItems()
{
    ...
    ui->tableWidget->setHorizontalHeaderLabels(QStringList() << "ID" << QStringLiteral("名称") << QStringLiteral("价值") << QStringLiteral("重量") << QStringLiteral("数量") << QStringLiteral("种类"));
...
void MainWindow::on_tableWidget_itemDoubleClicked(QTableWidgetItem *item)
{
    ...
    StatusBarMessage(QStringLiteral("当前选中: ") + QString::fromStdString(itemManager->getItem(id).name));
}
...
void MainWindow::on_tableWidget_itemPressed(QTableWidgetItem *item)
{
    ...
    StatusBarMessage(QStringLiteral("当前焦点: ") + QString::fromStdString(itemManager->getItem(id).name));
...
void MainWindow::mouseMoveEvent(QMouseEvent *event)
{
    ...
    //     int column = ui->tableWidget->columnAt(x);
        StatusBarMessage(QStringLiteral("当前坐标: ") + QString::number(x) + ", " + QString::number(y));
